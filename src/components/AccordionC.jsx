import { useState, useRef, useEffect } from 'react';
    ...
    const accordionContent = {
        ...
        conferences: (
            <ul>
                <li><p className="text-left"><b>Κωστικίδης Χ. & Πασχάλη Μ. (Απρίλιος 2015)</b><br/>Επιστημονικό εργαστήριο με θέμα «Η φτώχεια και η στέρηση στην Ελλάδα. Ο κοινωνικός αντίκτυπος της κρίσης», το οποίο διοργανώθηκε στην Κομοτηνή από τη Διεύθυνση Δευτεροβάθμιας Εκπαίδευσης Ροδόπης, μέσω της Δομής Συμβουλευτικής Νέων, σε συνεργασία με το Τμήμα Κοινωνικής Διοίκησης και Πολιτικής Επιστήμης του Δημοκρίτειου Πανεπιστημίου Θράκης.</p></li>
                <li><p className="text-left"><b>Κωστικίδης Χ. (Νοέμβριος 2024)</b><br/>Συνέδριο Κοινωνική Εργασία στην εποχή των «ρευστών βεβαιοτήτων»: Συνδέοντας την εμπειρία από το πεδίο με έρευνα. Τίτλος παρουσίασης: Από την ακούσια νοσηλεία στην κοινοτική ψυχιατρική φροντίδα: Προβλήματα και προοπτικές.</p></li>
            </ul>
        ),
        perspective: (
            <>
